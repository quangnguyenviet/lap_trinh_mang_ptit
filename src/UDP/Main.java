...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        int port = 2209;
        String ms1 = ";B22DCCN650;9pntFN9y";
...
//        System.out.println(rid);
        ByteArrayInputStream bais = new ByteArrayInputStream(in.getData(), 8, in.getLength());
        ...
        oos.writeObject(b);
//        oos.flush();
        byte[] bs1 = new byte[8 + baos.size()];
        System.arraycopy(rid.getBytes(), 0, bs1, 0, 8);
        System.arraycopy(baos.toByteArray(), 0, bs1, 8, baos.size());
        out = new DatagramPacket(bs1, bs1.length, sA, port);
